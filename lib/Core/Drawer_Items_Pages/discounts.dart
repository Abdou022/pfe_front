...
class _DiscountPageState extends State<DiscountPage> {
  ...
  Future<void> fetchDiscountedProducts() async {
    try {
      ...
      final prods = await apiService.getDiscountedProducts().whenComplete(() => setState(() {
              isLoading = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Promotions",style: const TextStyle(
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              ...
                                              child: Icon(
                                                ...
                                                color:snapshot.data![index]["isFavorite"]                           //khedmet khadija
                                                  ? Colors.red
                                                  : Colors.grey,
