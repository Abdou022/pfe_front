...
class _NotificationsState extends State<Notifications> {
  ...
  Future<List<NotificationModel>> getAllNotiifications() async {
    ...
    const String url = "http://192.168.1.13:5000/notifications/";
              ...
              itemBuilder: (context, index) => Container(
                ...
                child: Column(
                  children: [
                    ...
                    ListTile(
                      leading: ClipOval(child: Image.network("${snapshot.data?[index].productPic}", ),),
                      title: Text("New Discount!", style: TextStyle(fontFamily: 'Poppins', color: Colors.black, fontWeight: FontWeight.bold),),
                      subtitle: Text("${snapshot.data?[index].content}", style: TextStyle(fontFamily: 'Poppins', color: Colors.black),),
                    ),
                  ],
                ),
              ),
