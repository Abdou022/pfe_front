        ...
        body: SafeArea(
          ...
          child: Column(children: [
            ...
            FutureBuilder<ProductModel>(
              future:  widget.identifier.length>13 ? _productApiCall.getProductById(widget.identifier) : _productApiCall.getProductByBarCode(widget.identifier),
              builder: (context, snapshot) {
                ...
                if (snapshot.hasData) {
                      ...
                      Row(
                          children: [
                            ...
                            Text(
                              ...
                              style: const TextStyle(color: Color(0xFFFFBD59),fontFamily: 'Poppins',fontSize: 16),
                            ),
                          ],
                        ),
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Text("Brand:    ",style: const TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontFamily: 'Poppins',fontSize: 16),),
                                  Text("${snapshot.data?.brand}",style: const TextStyle(color: Color(0xFFDF9A4F),fontWeight: FontWeight.bold,fontFamily: 'Poppins',fontSize: 16),)
                                ],
                              ),
                        ...
                        Column(
                                ...
                                child: Padding(
                                  ...
                                  child: ListView.separated(
                                    ...
                                    itemBuilder:(context, index) => Container(
                                      ...
                                      color: HelperFunctions.getColor("${snapshot.data?.colors[index]}")!,
                                                ),
                                    ), 
                                  ),
                                ),
                                ...
                                child: Padding(
                                  ...
                                  child: ListView.separated(
                                    ...
                                    itemBuilder:(context, index) => Container(
                                      ...
                                      borderRadius: BorderRadius.circular(10),),
                                      child: Text("${snapshot.data?.size[index]}", style: TextStyle(fontFamily: 'Poppins',fontSize: 18,fontWeight: FontWeight.w600),),
                                    ), 
                                  ),
                                ),
                              ),
                              SizedBox(height: 10,),
                              Text("Description",style: const TextStyle(fontFamily: 'Poppins',fontSize: 18,fontWeight: FontWeight.w600),),
                              SizedBox(height: 10,),
                              ReadMoreText(
                            ...
                            lessStyle: const TextStyle(
                              ...
                              SizedBox(height: 10,),
                              Text("Shops",style: const TextStyle(fontFamily: 'Poppins',fontSize: 18,fontWeight: FontWeight.w600),),
                              SizedBox(height: 10,),
                              Container(height: snapshot.data!.shops.length*150,
                              width: MediaQuery.of(context).size.width,
                                child: ListView.separated(
                                  physics: NeverScrollableScrollPhysics(),
                                                                  ...
                                                                  child: Row(
                                                                    children: [
                                                                      ...
                                                                      Column(
                                                                        ...
                                                                        children: [
                                      Text("${snapshot.data?.shops[index]}",style: const TextStyle(fontFamily: 'Poppins',fontSize: 18,fontWeight: FontWeight.w600),),
                                                                        ],
                                                                      )
                                                                    ],
                                                                  ),
                  ...
                  print("Hello error fi product detail page: ${snapshot.error}");
                  return Center(child: 
                  //Text("hello ${snapshot.error}")
                  CircularProgressIndicator(color: Color(0xFF965D1A),));
                }
              },
            )
          ]
