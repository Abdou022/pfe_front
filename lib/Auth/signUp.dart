...
class _SignUpState extends State<SignUp> {
  ...
  Future<void> signup(
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse('http://192.168.1.15:5000/auth/signup'));
    request.fields
    ...
    if (jsonResponse["status"]) {
      ...
      print(userToken);
      Navigator.pushReplacement(context, CupertinoPageRoute(builder:(context) => RegisterVerification(userId: userId),));
    }
  }
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (_usernamecntrl.text.length > 2 &&
                          ...
                          signup(_usernamecntrl.text, _emailcntrl.text,
                                  _passwordcntrl.text, selectedImage!)
                        ...
                        if(_image == null){
                          Fluttertoast.showToast(msg: "Add Profile Picture",toastLength: Toast.LENGTH_LONG,
                                    backgroundColor:
                                        Colors.black.withOpacity(0.7),);
                        }
                        setState(() {
