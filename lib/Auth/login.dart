      ...
      body: SafeArea(child: 
        Center(
          ...
          children: [
             ...
             Image.asset("assets/images/welcome_back.png", width: 230,),
             const Divider(indent:80,endIndent: 80,),
            const Padding(
              padding: EdgeInsets.symmetric(horizontal:10 ,vertical: 10),
              child: Text("Login with your Email and Password for personalized shopping experiences just for you", style: TextStyle(fontWeight: FontWeight.w600, color: Color.fromARGB(255, 129, 129, 129),fontFamily: 'Poppins',fontSize: 12),textAlign: TextAlign.center ,),
            ),
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  errorStyle: const TextStyle(color: Colors.red, fontSize: 11,fontFamily: 'Poppins'),
                ),
                onChanged: (value) {
                  setState(() {
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffix:  IconButton(
                    icon :
                      isObscured ? const Icon(CupertinoIcons.eye_slash_fill,size: 23,color:Color.fromARGB(255, 97, 84, 72) ,):const Icon(CupertinoIcons.eye_fill,size: 23,color:Color.fromARGB(255, 97, 84, 72) ,) ,
                      onPressed: (){
                        setState(() {
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: TextButton(
                      style: ButtonStyle(overlayColor: MaterialStateColor.resolveWith((states) => const Color.fromARGB(255, 255, 237, 211)),),
                           child: const Text(
                    "Forgot Password?",
                    style: TextStyle(
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    const Text("You don't have an account?",style: TextStyle(fontFamily: 'Poppins',fontSize: 13),),
                    TextButton(
                      style: ButtonStyle(overlayColor: MaterialStateColor.resolveWith((states) => const Color.fromARGB(255, 255, 237, 211)),),
                           child: const Text(
                    "Sign Up",
