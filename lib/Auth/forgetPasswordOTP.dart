...
class _ForgetPasswordOTPState extends State<ForgetPasswordOTP> {
  ...
  Future<void> otpVerification(String otp) async {
    ...
    String url = 'http://192.168.1.13:5000/auth/otp';
  ...
  Future<void> resendOtpVerification() async {
    ...
    String url = 'http://192.168.1.13:5000/auth/resendOtp';
    var response = await http.post(Uri.parse(url),
    headers: {'Content-Type': 'application/json'},
    body: reqBody);
    var jsonResponse = jsonDecode(response.body);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10,),
              const Text("We Sent a Verification Code To Your Email",style: TextStyle(fontFamily: 'Poppins',fontSize: 13,fontWeight: FontWeight.w600),),
              Row(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                 ...
                 child:const Text(
                        'Verify',
                        style: TextStyle(color: Color(0xFF965D1A),fontSize: 20,fontWeight: FontWeight.bold,fontFamily: 'Poppins'),
                                      ),),
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  const Text("Didn't Receive The Code?",style: TextStyle(fontFamily: 'Poppins',fontSize: 12, fontWeight: FontWeight.bold),),
                  TextButton(onPressed: (){
                    resendOtpVerification().whenComplete(() => Fluttertoast.showToast(msg: message,
                    toastLength: Toast.LENGTH_LONG,
                    backgroundColor:Colors.black.withOpacity(0.7),
                    ));
                  },
